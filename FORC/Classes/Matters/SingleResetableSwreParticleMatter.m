classdef SingleResetableSwreParticleMatter <iMatter
    ...
    methods
        ...
        function obj = SingleResetableSwreParticleMatter(particle)
            if(nargin<1)
            ...
            obj.InRealUnits = particle.InRealUnits;
        ...
        function  Matter =  SaturateToPositive(matter)
            Matter=matter;
            Matter.Particle = SwParticleRotativeElastic(matter.Particle.AngleFA, matter.Particle.k);
            Matter.Particle = Matter.Particle.SetIsInRealUnitMeasurements(matter.InRealUnits);
